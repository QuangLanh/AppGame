...
public class TracNghiemDoMeo_Hard_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trac_nghiem_do_meo__hard_);
        //ánh xạ giao diện
        txtdiemcong = findViewById(R.id.txtdiemcong_domeo_hard);
        txthienthidiem = findViewById(R.id.txthienthidiem_domeo_hard);
        btnhome = findViewById(R.id.btnhome_domeo_hard);
        tv_count_question = findViewById(R.id.count_question_domeo);
        tv_title_domeo = findViewById(R.id.tvTitle_domeo);
        tv_cauhoi_domeo= findViewById(R.id.tv_cauhoi_domeo_hard);
        tv_dapanA_domeo = findViewById(R.id.tv_dapanA_domeo_hard);
        tv_dapanB_domeo= findViewById(R.id.tv_dapanB_domeo_hard);
        tv_dapanC_domeo = findViewById(R.id.tv_dapanC_domeo_hard);
        tv_dapanD_domeo = findViewById(R.id.tv_dapanD_domeo_hard);
        //animation title
        chuyenCauhoi();
        ...
        btnhome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(TracNghiemDoMeo_Hard_Activity.this, TheLoaiActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void chuyenCauhoi()
    {
        ...
        {
            databaseReference = database.getInstance().getReference().child("TheLoai").child("DoMeo").child("Kho").child(String.valueOf(total));
    ...
    public void KetThuc(){
        Intent i =  new Intent(TracNghiemDoMeo_Hard_Activity.this, KetQuaActivity.class);
