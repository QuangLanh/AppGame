...
public class TracNghiemTheThao_Easy_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trac_nghiem_theo_thao_easy);
        //ánh xạ giao diện
        txtdiemcong = findViewById(R.id.txtdiemcong_thethao_easy);
        txthienthidiem = findViewById(R.id.txthienthidiem_thethao_easy);
        btnhome = findViewById(R.id.btnhome_thethao_easy);
        tv_count_question = findViewById(R.id.count_question_thethao);
        tvTitle_thethao = findViewById(R.id.tvTitle_theothao);
        tv_cauhoi_thethao = findViewById(R.id.tv_cauhoi_thethao);
        tv_dapanA_thethao = findViewById(R.id.tv_dapanA_thethao);
        tv_dapanB_thethao = findViewById(R.id.tv_dapanB_thethao);
        tv_dapanC_thethao = findViewById(R.id.tv_dapanC_thethao);
        tv_dapanD_thethao = findViewById(R.id.tv_dapanD_thethao);
        chuyenCauhoi();
        //animation Title
        ...
        btnhome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(TracNghiemTheThao_Easy_Activity.this, TheLoaiActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void chuyenCauhoi()
    {
        ...
        if (total > 15)
        {
            ...
            {
                databaseReference = database.getInstance().getReference().child("TheLoai").child("TheThao").child("De").child(String.valueOf(total));
    ...
    public void KetThuc(){
        Intent i =  new Intent(TracNghiemTheThao_Easy_Activity.this, KetQuaActivity.class);
