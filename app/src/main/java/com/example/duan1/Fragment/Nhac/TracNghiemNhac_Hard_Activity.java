...
public class TracNghiemNhac_Hard_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trac_nghiem_nhac__hard_);
        //ánh xạ giao diện
        tvTitle_amnhac = findViewById(R.id.tvTitle_amnhac_hard);
        txtdiemcong = findViewById(R.id.txtdiemcong_nhac_hard);
        txthienthidiem = findViewById(R.id.txthienthidiem_nhac_hard);
        btnhome = findViewById(R.id.btnhome_nhac_hard);
        tv_count_question = findViewById(R.id.count_question_amnhac);
        tv_cauhoi_amnhac= findViewById(R.id.tv_cauhoi_amnhac_hard);
        tv_dapanA_amnhac = findViewById(R.id.tv_dapanA_amnhac_hard);
        tv_dapanB_amnhac= findViewById(R.id.tv_dapanB_amnhac_hard);
        tv_dapanC_amnhac = findViewById(R.id.tv_dapanC_amnhac_hard);
        tv_dapanD_amnhac = findViewById(R.id.tv_dapanD_amnhac_hard);
        tvTitle_amnhac = findViewById(R.id.tvTitle_amnhac_hard);
        //animation title
        ...
        Intent i = new Intent(TracNghiemNhac_Hard_Activity.this, Sevice_media_nhacnnen_amnhac.class);
        Intent i1 = new Intent(TracNghiemNhac_Hard_Activity.this, Sevice_media.class);
        startService(i);
        stopService(i1);
        chuyenCauhoi();
        //btnhome
        btnhome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(TracNghiemNhac_Hard_Activity.this, TheLoaiActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void chuyenCauhoi()
    {
        ...
        {
            databaseReference = database.getInstance().getReference().child("TheLoai").child("AmNhac").child("Kho").child(String.valueOf(total));
            ...
            databaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    tv_dapanA_amnhac.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            if (SystemClock.elapsedRealtime() - lastime<1000){
                                return;
                            }
    ...
    public void KetThuc(){
        Intent i =  new Intent(TracNghiemNhac_Hard_Activity.this, KetQuaActivity.class);
