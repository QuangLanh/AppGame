...
public class TracNghiemDiaLy_Hard_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trac_nghiem_dia_ly__hard_);
        //ánh xạ giao diện
        txtdiemcong = findViewById(R.id.txtdiemcong_dialy_hard);
        txthienthidiem = findViewById(R.id.txthienthidiem_dialy_hard);
        btnhome = findViewById(R.id.btnhome_dialy_hard);
        tv_count_question = findViewById(R.id.count_question);
        tv_cauhoi_dialy= findViewById(R.id.tv_cauhoi_dialy_hard);
        tv_dapanA_dialy = findViewById(R.id.tv_dapanA_dialy_hard);
        tv_dapanB_dialy =  findViewById(R.id.tv_dapanB_dialy_hard);
        tv_dapanC_dialy = findViewById(R.id.tv_dapanC_dialy_hard);
        tv_dapanD_dialy = findViewById(R.id.tv_dapanD_dialy_hard);
        tv_title_dialy = findViewById(R.id.tvTitle_dialy_hard);
        //animation title
        ...
        btnhome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(TracNghiemDiaLy_Hard_Activity.this, TheLoaiActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void chuyenCauhoi()
    {
        ...
        {
            databaseReference = database.getInstance().getReference().child("TheLoai").child("DiaLy").child("Kho").child(String.valueOf(total));
    ...
    public void KetThuc(){
        Intent i =  new Intent(TracNghiemDiaLy_Hard_Activity.this, KetQuaActivity.class);
