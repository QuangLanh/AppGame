...
public class TracNghiemPhimAnh_Easy_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trac_nghiem_phim_anh__easy_);
        //ánh xạ giao diện
        tv_count_question = findViewById(R.id.count_question_phim);
        tvTitle_phimanh = findViewById(R.id.tvTitle_phimanh);
        txtdiemcong = findViewById(R.id.txtdiemcong_phim_easy);
        txthienthidiem = findViewById(R.id.txthienthidiem_phim_easy);
        btnhome = findViewById(R.id.btnhome_phim_easy);
        tv_cauhoi_phimanh= findViewById(R.id.tv_cauhoi_phimanh);
        tv_dapanA_phimanh = findViewById(R.id.tv_dapanA_phimanh);
        tv_dapanB_phimanh= findViewById(R.id.tv_dapanB_phimanh);
        tv_dapanC_phimanh = findViewById(R.id.tv_dapanC_phimanh);
        tv_dapanD_phimanh = findViewById(R.id.tv_dapanD_phimanh);
        tvTitle_phimanh = findViewById(R.id.tvTitle_phimanh);
        //animation title
        ...
        btnhome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(TracNghiemPhimAnh_Easy_Activity.this, TheLoaiActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void chuyenCauhoi()
    {
        ...
        {
            databaseReference = database.getInstance().getReference().child("TheLoai").child("PhimAnh").child("De").child(String.valueOf(total));
    ...
    public void KetThuc(){
        Intent i =  new Intent(TracNghiemPhimAnh_Easy_Activity.this, KetQuaActivity.class);
